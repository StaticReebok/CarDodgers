 ...
 */
 ...
 public abstract class Entity {
    ...
    private Rectangle him = new Rectangle(); // bounding rect. of other entities
     ...
     // Constructor input: reference to the image for this entity, 
     ...
     // move  input: delta - the amount of time passed in ms  output: none 
     // purpose: after a certain amout of time has passed, update the location
     ...
     // collidesWith  input: the other entity to check collision against 
     ...
     public boolean collidesWith(Entity other) {
      ...
      // collidedWith  input: the entity with which this has collided
